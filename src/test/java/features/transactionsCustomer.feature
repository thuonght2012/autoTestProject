Feature: Customer transactions
  ...
  Scenario Outline: User can see transactions table
    ...
    And I deposited extra into account <deposit1>
    And I withdrawal into account <withdrawal>
    And I click on Transactions button
    Then I verify table is appeared and show deposit success
    ...
    Examples:
      | name         | deposit | deposit1 | withdrawal |
      | Harry Potter | 3000    | 3000     | 2000      |